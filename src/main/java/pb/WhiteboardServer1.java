...
//				System.out.println("current shared board List : "+s);
//				endpoint.emit(sharingBoard,s);
//			}
//
//			endpoint.on(WhiteboardServer.shareBoard, (eventArgs2)->{
//				String boardName = (String) eventArgs2[0];
//				System.out.println("a whiteboard wants to be shared : "+ boardName);
//				boardSet.add(boardName);
//				for (String s:boardSet) {
//					System.out.println("current shared board List : "+s);
//				}
//				WhiteboardServer.liveEndpoints.forEach((ep) -> {
//					if(ep!=endpoint) {
//						ep.emit(WhiteboardServer.sharingBoard, boardName);
//					}else {
//						System.out.println("need not to send to this endpoint");
//					}
//				});
//			}).on(WhiteboardServer.unshareBoard, (eventArgs2)->{
//				String boardName = (String) eventArgs2[0];
//				System.out.println("a whiteboard wants to be unshared");
//				WhiteboardServer.liveEndpoints.forEach((ep) -> {
//					if(ep!=endpoint) {
//						ep.emit(WhiteboardServer.unsharingBoard, boardName);
//					}else {
//						System.out.println("need not to send to this endpoint");
//					}
//				});
...
//			System.out.println("current liveEndpoints number: "+liveEndpoints.size());
