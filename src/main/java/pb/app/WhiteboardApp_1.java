...
//
//	public static Set<Endpoint> liveEndpoints = new HashSet<>();
//
//	/**
...
//
//			System.out.println("peerStarted:7777777777777777");
//			Endpoint endpoint = (Endpoint) eventArgs[0];
//			liveEndpoints.add(endpoint);
//
//			endpoint.on(listenBoard, (eventArgs2)->{
//				System.out.println("a board want to listen");
//
//			}).on(unlistenBoard, (eventArgs2)->{
//				System.out.println("fileError");
//			}).on(WhiteboardApp.getBoardData, (eventArgs2)->{
//				String name1 = (String) eventArgs2[0];
//
//				String theBoardData = whiteboards.get(name1).toString();
//				System.out.println("this board needs to be shared: "+name1);
//
//				endpoint.emit(WhiteboardApp.boardData,theBoardData);
//			});
//
//		}).on(PeerManager.peerStopped,(eventArgs)->{
//			Endpoint endpoint = (Endpoint) eventArgs[0];
//			log.info("querySide peerStopped: "+endpoint.getOtherEndpointId());
//		}).on(PeerManager.peerError,(eventArgs)->{
//			Endpoint endpoint = (Endpoint) eventArgs[0];
//			log.info("querySide peerError : "+endpoint.getOtherEndpointId());
//		}).on(PeerManager.peerServerManager,(eventArgs)->{
//			ServerManager serverManager  = (ServerManager) eventArgs[0];
//			log.info("peerServerManager is ready");
//			System.out.println("peerServerManager is ready");
//			serverManager.on(IOThread.ioThread,(eventArgs2)->{
//				String peerport = (String) eventArgs2[0];
//				// now connect to the index server, i.e. call index update
//
//				log.info("IOThread is ready");
//
//			});
//
//		});
...
//				clientEP = (Endpoint) eventArgs[0];
//				clientEP.on(WhiteboardServer.sharingBoard,(eventArgs2)->{
//					String sharingBoard = (String) eventArgs2[0];
//					if (sharingBoard == "") {
//						System.out.println("no sharedBoard");
//					}else {
//						System.out.println("a sharing board: "+ sharingBoard);
//
////						Whiteboard wb = new Whiteboard(sharingBoard,true);
////
////						addBoard(wb,false);
//
//
//						System.out.println("selectedABoard 9999999999999999999999999999");
//
//						connectToPeer(sharingBoard);
//					}
//				});
//				System.out.println("peerStarted:8888888888");
//			});
//			clientManager.start();
//
...
//	public void connectToPeer (String sharingBoard){
//		String[] parts=sharingBoard.split(":");
//		String host = parts[0];
...
//			clientManager.on(PeerManager.peerStarted,(eventArgs)->{
//
//				System.out.println("I want to get board......................................");
//
//				Endpoint endpoint = (Endpoint) eventArgs[0];
//				endpoint.on(WhiteboardApp.boardData,(eventArgs2)->{
//					String theBoardData = (String) eventArgs2[0];
//
//					Whiteboard wb = new Whiteboard(sharingBoard,true);
//					wb.whiteboardFromString(WhiteboardApp.getBoardName(theBoardData),WhiteboardApp.getBoardData(theBoardData));
//					addBoard(wb,false);
//
//					//System.out.println("boardData: "+ theBoardData);
//				}).on(WhiteboardApp.boardPathUpdate,(eventArgs2)-> {
//					String update = (String) eventArgs2[0];
//
//
//					long version = getBoardVersion(update)-1;
//					System.out.println("version: "+version);
//					System.out.println("WhiteboardPath: "+getBoardPaths(update));
//					WhiteboardPath newPath = new WhiteboardPath(getBoardPaths(update));
//
//					boolean flag = selectedBoard.addPath(newPath, version );
//					System.out.println("flag: "+flag);
//					drawSelectedWhiteboard();
//
//				});
//				endpoint.emit(listenBoard,"");
//				endpoint.emit(WhiteboardApp.getBoardData,sharingBoard);
//
//
//			}).on(PeerManager.peerStopped,(eventArgs)->{
//				System.out.println("peerStopped");
//			}).on(PeerManager.peerError,(eventArgs)->{
//				System.out.println("peerError");
//			});
//			clientManager.start();
//		} catch (UnknownHostException e) {
//			e.printStackTrace();
...
//				System.out.println("selectedBoard.isRemote(): "+selectedBoard.isRemote());
//				System.out.println(currentPath.toString());
//				System.out.println("add a path.........................................");
//				String updateData = selectedBoard.getName()+"%"+selectedBoard.getVersion()+"%"+currentPath.toString();
//				WhiteboardApp.liveEndpoints.forEach((endpoint) -> {
//					endpoint.emit(WhiteboardApp.boardPathUpdate,updateData);
//				});
//			}
//		} else {
...
//			System.out.println("set share");
//			clientEP.emit(WhiteboardServer.shareBoard, selectedBoard.getName());
//		} else {
